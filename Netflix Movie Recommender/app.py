...
movie_load = pickle.load(open('/Users/amitpandey/MOVIE_RECOMMENDER_classification/recommender_model.pkl', 'rb'))
movies = pd.DataFrame(movie_load)

similarity = pickle.load(open('/Users/amitpandey/similarity.pkl', 'rb'))
